...
| Curso | Certificado |
| :--- | :---: |
| Diploma backend python Django | [Ver PDF](https://github.com/LeoSan/CursosBackendPython/blob/main/01_Primeros_pasos_Python/2025_Diploma-backend-python_Django_PLATZI.pdf) |
