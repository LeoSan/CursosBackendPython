...
class ApiClientTests(unittest.TestCase):
    ...
    @patch('src.api_client.requests.get')## Crea una nueva varible que vamos a recibir dentro del metodo 
    def test_get_location_returns_expected_data(self, mock_get):
        ...
        mock_get.assert_called_once_with("https://freeipapi.com/api/json/8.8.8.8")## Es para confirmar que estamos llamado bien el metodo 
