...
'''
Version de selenium 4.3.0: se cambiaron los buscadores por las formas de buscar, donde ahora find_elements o find_element se incluye solo y dentro de los paretesis se incluyo el selector o el buscador especifico ejem antes se escribía de esta forma "self.driver.find_element_by_class_name( "button")" ahora es "self.driver.find_element("class name", "button")" de igual forma para todos los delas buscadores
'''
